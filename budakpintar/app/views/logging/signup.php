                ...
                <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                    <form>
                        <div
                            ...
                            <p class="lead fw-normal fs-3 mb-0 me-3">Sign up</p>
                        </div>

                        <!-- Username input -->
                        <div class="form-outline mb-4 mt-3">
                            <input type="text" id="signup-username" class="form-control form-control-lg"
                                placeholder="Masukkan nama pengguna" />
                            <!-- <label class="form-label" for="signup-username">Email address</label> -->
                        </div>
                        ...
                        <div class="text-center text-lg-start mt-4 pt-2">
                            ...
                            <p class="small fw-bold mt-2 pt-1 mb-0">Sudah punya akun? <a href="<?=BASEURL?>/logging/"
